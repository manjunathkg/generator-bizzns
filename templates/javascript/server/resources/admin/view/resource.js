...
module['exports'] = function (options, callback) {
  ...
  var  schemaView = view.parent.schema.present({ schema: _resource.schema },function(err,schemaView){
    //console.log("=======>>>>>>  about to call schema js thing- IN Callback :: schemaView ==  " + schemaView );
    $('.properties').html(schemaView);
    //console.log("=======>>>AFTER  to call schema js thing");
  });
  }
