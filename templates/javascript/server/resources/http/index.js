...
function mergeParams (req, res, next) {
  console.log("******** INSIDE Merger PARAMS***");
  req.resource = req.resource || {};
  req.resource.params = {};
   console.log("******** INSIDE Merger PARAMS*** req.resource.params = " + req.resource.params);
  //
  ...
  console.log("&&&&&&&&&  typeof req.__req " + typeof req.__req);
  var util=require('util');
  
  console.log("&&&&&&&&&  typeof req.__req " + util.inspect(req.resource.params));

  if (typeof req.params === 'object') {
    console.log("type of req.params was object");
