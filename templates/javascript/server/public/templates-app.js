angular.module('templates-app', ['MainHome.tpl.html', 'admin/projects/projects-edit.tpl.html', 'admin/projects/projects-list.tpl.html', 'admin/users/users-edit.tpl.html', 'admin/users/users-list.tpl.html', 'dashboard/dashboard.tpl.html', 'projects/productbacklog/productbacklog-edit.tpl.html', 'projects/productbacklog/productbacklog-list.tpl.html', 'projects/projects-list.tpl.html', 'projects/sprints/sprints-edit.tpl.html', 'projects/sprints/sprints-list.tpl.html', 'projects/sprints/tasks/tasks-edit.tpl.html', 'projects/sprints/tasks/tasks-list.tpl.html', 'projectsinfo/list.tpl.html', 'route1/Route1Home.tpl.html', 'route2/Route2Home.tpl.html', 'route3/Route3Home.tpl.html', 'route4/Route4Home.tpl.html']);

angular.module("MainHome.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("MainHome.tpl.html",
    "<div  ui-view>\n" +
    "<h1>   \n" +
    ...
    "\n" +
    "<div ui-view>\n" +
    "	Sub views of the page Main come here\n" +
    "</div>");
}]);
...
angular.module("route1/Route1Home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("route1/Route1Home.tpl.html",
    "<div>\n" +
    "<h1>   \n" +
    "   View For Route1 Home Page\n" +
    "   \n" +
    "</h1>\n" +
    "\n" +
    "</div>\n" +
    "<admin-top-header></admin-top-header>\n" +
    "<div ui-view>\n" +
    "	Sub views of the page Route1 come here\n" +
    "</div>");
}]);

angular.module("route2/Route2Home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("route2/Route2Home.tpl.html",
    "<div >\n" +
    "<h1>   \n" +
    "   View For Route2 Home Page\n" +
    "   \n" +
    "</h1>\n" +
    "</div>\n" +
    "\n" +
    ...
    "\n" +
    "<div ui-view>\n" +
    "	Sub views of the page Route2 come here\n" +
    "</div>");
}]);

angular.module("route3/Route3Home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("route3/Route3Home.tpl.html",
    "<div  ui-view>\n" +
    "<h1>   \n" +
    "   View For Route3 Home Page\n" +
    "   \n" +
    "</h1>\n" +
    "</div>\n" +
    "\n" +
    "<div ui-view>\n" +
    "	Sub views of the page Route3 come here\n" +
    "</div>");
}]);

angular.module("route4/Route4Home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("route4/Route4Home.tpl.html",
    "<div  ui-view>\n" +
    "<h1>   \n" +
    "   View For Route4 Home Page\n" +
    "   \n" +
    "</h1>\n" +
    "</div>\n" +
    "\n" +
    "<div ui-view>\n" +
    "	Sub views of the page Route4 come here\n" +
    "</div>");
}]);
